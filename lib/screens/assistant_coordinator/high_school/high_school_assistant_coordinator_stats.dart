...
class HighSchoolAssistantCoordinatorStats extends StatefulWidget {
  const HighSchoolAssistantCoordinatorStats({super.key});

  @override
  State<HighSchoolAssistantCoordinatorStats> createState() =>
      _HighSchoolAssistantCoordinatorStatsState();
}

class _HighSchoolAssistantCoordinatorStatsState
    extends State<HighSchoolAssistantCoordinatorStats> {
  ...
  Future<void> _generateReport() async {
    ...
    switch (_selectedReportType) {
      case 'Active Students':
                        context.push('/highSchoolAssistantCoordinatorStatsActiveStudents', extra: {
        ...
        break;
      case 'Activities':
                  context.push('/highSchoolAssistantCoordinatorStatsActivities', extra: {
          'selectedMentors': _selectedMentors,
          'selectedCity': _selectedCity,
          'selectedUnit': _selectedUnit,
          'selectedGrades': _selectedGrades,
      ...
      case 'Activity Counts':
                  context.push('/highSchoolAssistantCoordinatorStatsActivityCounts', extra: {
          'selectedMentors': _selectedMentors,
          'selectedCity': _selectedCity,
          'selectedUnit': _selectedUnit,
          'selectedGrades': _selectedGrades,
      ...
      case 'Activity Counts By Mentor':
                  context.push('/highSchoolAssistantCoordinatorStatsActivityCountsByMentor', extra: {
          'selectedMentors': _selectedMentors,
          'selectedCity': _selectedCity,
          'selectedUnit': _selectedUnit,
          'selectedGrades': _selectedGrades,
