...
class HighSchoolUnitCoordinatorStatsActivityCountsPage extends StatefulWidget {
  final Map<String, dynamic> filters;
  const HighSchoolUnitCoordinatorStatsActivityCountsPage({super.key, required this.filters});

  @override
  State<HighSchoolUnitCoordinatorStatsActivityCountsPage> createState() => _HighSchoolUnitCoordinatorStatsActivityCountsPageState();
}

class _HighSchoolUnitCoordinatorStatsActivityCountsPageState extends State<HighSchoolUnitCoordinatorStatsActivityCountsPage> {
