...
class HighSchoolUnitCoordinatorStatsActiveStudentsPage extends StatefulWidget {
  final Map<String, dynamic> filters;
  const HighSchoolUnitCoordinatorStatsActiveStudentsPage({super.key, required this.filters});

  @override
  State<HighSchoolUnitCoordinatorStatsActiveStudentsPage> createState() => _HighSchoolUnitCoordinatorStatsActiveStudentsPageState();
}

class _HighSchoolUnitCoordinatorStatsActiveStudentsPageState extends State<HighSchoolUnitCoordinatorStatsActiveStudentsPage> {
