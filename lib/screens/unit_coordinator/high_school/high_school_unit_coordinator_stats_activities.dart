...
class HighSchoolUnitCoordinatorStatsActivitiesPage extends StatefulWidget {
  final Map<String, dynamic> filters;
  const HighSchoolUnitCoordinatorStatsActivitiesPage({super.key, required this.filters});

  @override
  State<HighSchoolUnitCoordinatorStatsActivitiesPage> createState() => _HighSchoolUnitCoordinatorStatsActivitiesPageState();
}

class _HighSchoolUnitCoordinatorStatsActivitiesPageState extends State<HighSchoolUnitCoordinatorStatsActivitiesPage> {
