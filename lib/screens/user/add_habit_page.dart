...
class _AddHabitPageState extends State<AddHabitPage>
  ...
  String?
      _loadingHabitName; // Track which habit is loading instead of global loading
  String? _error;
  ...
  void _showSuccessMessageWithTimer(String message) {
    ...
    _successMessageTimer =
      ...
      setState(() {
        ...
        _countdown =
            (_progressValue * 5).ceil(); // Real-time countdown from progress
            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  margin:
                      EdgeInsets.symmetric(horizontal: isLargeScreen ? 24 : 20),
                  child: ListView(
                    ...
                    children: _habitCategories.keys.map((category) {
                      ...
                      return Semantics(
                        label:
                            '$category category${isSelected ? ', selected' : ''}',
                        child: Material(
                          color: Colors.transparent,
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final habit =
                            _habitCategories[_selectedCategory]![index];
  ...
  Future<void> _addHabit(Map<String, dynamic> habit) async {
    ...
    try {
      ...
      final existingHabit = await FirebaseFirestore.instance
          ...
          .timeout(
            ...
            onTimeout: () => throw TimeoutException(
                'Connection timeout', const Duration(seconds: 3)),
          );
      ...
      await batch.commit().timeout(
            const Duration(seconds: 3),
            onTimeout: () => throw TimeoutException(
                'Failed to save habit', const Duration(seconds: 3)),
          );
  ...
  Future<void> _checkNetworkConnectivity() async {
    try {
      ...
      await FirebaseAuth.instance.currentUser?.reload().timeout(
            ...
            onTimeout: () =>
                throw TimeoutException('Network connectivity check failed'),
          );
    } catch (e) {
      throw Exception(
