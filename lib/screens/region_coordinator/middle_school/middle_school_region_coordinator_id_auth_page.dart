...
class MiddleSchoolRegionCoordinatorIdAuthPage extends StatefulWidget {
  const MiddleSchoolRegionCoordinatorIdAuthPage({super.key});

  @override
  State<MiddleSchoolRegionCoordinatorIdAuthPage> createState() => _MiddleSchoolRegionCoordinatorIdAuthPageState();
}

class _MiddleSchoolRegionCoordinatorIdAuthPageState extends State<MiddleSchoolRegionCoordinatorIdAuthPage> {
