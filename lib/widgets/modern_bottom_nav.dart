      ...
      children: [
        ...
        Container(
          ...
          child: NavigationBar(
            ...
            elevation: 0, // NavigationBar'ın kendi gölgeliğini kaldır
            height: navHeight,
        ...
        // Top border line - positioned to overlap any spacing
        Positioned(
          top: 0,
          left: 0,
          right: 0,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        margin: EdgeInsets.fromLTRB(
          ...
          AppSpacing.screenPadding,
          AppSpacing.screenPadding +
              navHeight, // Responsive navigation bar height
        ),
      ),
    );
  }
